for plastic_num=1:6
fm_sal=zeros(4,51,20); w = warning ('off','all');
fug_sal=zeros(7,51,20); 
Knp_sal=[];
fm_size=zeros(51,20);
...
concentrationNP_a=0.001; %ug/L Plastic
%sal=500;
...
pb_sim4_concentration;%(NPsize_a,NCsize_a,NCconc_a,shear_a,densityNP_a,densityNC_a,...
...
Knp_sal=[Knp_sal ff_Knp];
 ...
 string_filename=strcat('plastic_fug',num2str(plastic_num),'_',num2str(NPsize_a),'nm_conc_effect.csv');
 ...
 string_filename=strcat('plastic_fate',num2str(plastic_num),'_',num2str(NPsize_a),'nm_conc_effect.csv');
 csvwrite(string_filename,fm1);
 string_filename=strcat('plastic_fate',num2str(plastic_num),'_',num2str(NPsize_a),'nm_conc_effect_size_of_aggregate.csv');
 csvwrite(string_filename,fm_size);
 string_filename=strcat('plastic_fate',num2str(plastic_num),'_',num2str(NPsize_a),'nm_conc_effect_Knp_rates.csv');
