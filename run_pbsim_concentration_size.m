...
concentrationNP_a=0.0001*1.585^(conc_count-1); %ug/L Plastic
%sal=500;
...
%  fm1=[fm1; fug_sal(:,:,16); fug_sal(:,:,17); fug_sal(:,:,18); fug_sal(:,:,19); fug_sal(:,:,20)];
 string_filename=strcat('plastic_fug_nv_',num2str(plastic_num),'_',num2str(concentrationNP_a),'ug_size_effect.csv');
...
%  fm1=[fm1; fm_sal(:,:,16); fm_sal(:,:,17); fm_sal(:,:,18); fm_sal(:,:,19); fm_sal(:,:,20)];
 string_filename=strcat('plastic_fate_nv_',num2str(plastic_num),'_',num2str(concentrationNP_a),'ug_size_effect.csv');
 csvwrite(string_filename,fm1);
 string_filename=strcat('plastic_fate_nv_',num2str(plastic_num),'_',num2str(concentrationNP_a),'ug_size_of_aggregate.csv');
 csvwrite(string_filename,fm_size);
 string_filename=strcat('plastic_fate_nv_',num2str(plastic_num),'_',num2str(concentrationNP_a),'ug_Knp_rates.csv');
