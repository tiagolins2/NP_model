...
Knp_sal=[Knp_sal ff_Knp];
 ...
 string_filename=strcat('plastic_fug',num2str(plastic_num),'_',num2str(concentrationNP_a),'ug_size_effect.csv');
 ...
 string_filename=strcat('plastic_fate',num2str(plastic_num),'_',num2str(concentrationNP_a),'ug_size_effect.csv');
 csvwrite(string_filename,fm1);
 string_filename=strcat('plastic_fate',num2str(plastic_num),'_',num2str(concentrationNP_a),'ug_size_of_aggregate.csv');
 csvwrite(string_filename,fm_size);
 string_filename=strcat('plastic_fate',num2str(plastic_num),'_',num2str(concentrationNP_a),'ug_Knp_rates.csv');
